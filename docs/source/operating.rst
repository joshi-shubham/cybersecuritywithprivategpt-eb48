[cybersecuritywithprivategpt-eb48] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-eb48] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-eb48] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   shubjoshi/cybersecuritywithprivategpt-eb48-amd64 (https://hub.docker.com/r/shubjoshi/cybersecuritywithprivategpt-eb48-amd64)
...
.. important::
   docker run -d -p 55369:55369 -p 53143:53143 -p 46849:46849 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-eb48 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-eb48 \-\-env GITUSERNAME=joshi-shubham  \-\-env GITREPOURL=https://github.com/joshi-shubham/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=55369  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=53143  \-\-env SOLUTIONVIPERVIZPORT=46849 \-\-env DOCKERUSERNAME='shubjoshi' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=38527 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='shubjoshi2056@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  shubjoshi/cybersecuritywithprivategpt-eb48-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=46849
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=55369
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - shubjoshi/cybersecuritywithprivategpt-eb48-amd64
...
It can be accessed by entering: http://localhost:53143
...
.. important::
   http://localhost:46849/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:46849/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:46849/<html file>
...
[cybersecuritywithprivategpt-eb48] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/joshi-shubham/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-eb48
...
.. important::
   https://cybersecuritywithprivategpt-eb48.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-eb48
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=55369, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42429, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37125, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34015, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46651, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=44383, HPDEHOST=127.0.1.1, HPDEPORT=41843, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=34011

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7144-cybersecuritywithprivategpt-eb48,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-eb48, python-preprocess-2051-cybersecuritywithprivategpt-eb48,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-eb48, python-ai-9057-cybersecuritywithprivategpt-eb48,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-eb48, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
